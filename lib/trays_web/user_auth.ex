defmodule TraysWeb.UserAuth do
  ...
  the current_user:
      ...
      defmodule TraysWeb.PageLive do
        ...
        on_mount {TraysWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{TraysWeb.UserAuth, :ensure_authenticated}] do
  ...
  def on_mount(:ensure_authenticated, _params, session, socket) do
    ...
    if socket.assigns.current_user do
      ...
      socket =
        ...
        |> Phoenix.LiveView.redirect(to: ~p"/#{TraysWeb.Cldr.get_my_locale()}/users/log_in")
  ...
  def require_authenticated_user(conn, _opts) do
    if conn.assigns[:current_user] do
      ...
      |> redirect(to: ~p"/#{TraysWeb.Cldr.get_my_locale()}/users/log_in")
      |> halt()
    end
  end
